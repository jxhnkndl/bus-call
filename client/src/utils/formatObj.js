...
export default function formatObj(obj) {
  return {
    ...
    schedule: [
      ...
      { timeString: obj.schedule[3].timeString, event: "The Bigger Lights" },
      { timeString: obj.schedule[4].timeString, event: "The Summer Set" },
      { timeString: obj.schedule[5].timeString, event: "This Providence" },
      { timeString: obj.schedule[6].timeString, event: "Cartel" },
